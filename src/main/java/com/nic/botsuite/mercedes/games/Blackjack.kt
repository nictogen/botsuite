...
//    addField("To Bet:", "`@Main the Money Bot#8859 bet <amount>`", true)
//    addField("Join Game", "✅", true)
//    addField("Leave Game", "\uD83D\uDEAB", true)
//}) : Question(message, players[0].user, message.id) {
//
...
//                    }
//                } else {
//                    MercedesMenus.Notify(message, "You don't have that much, sorry!", user)
//                }
//            }
//        } catch (e: Exception) { }
//    }
...
//                                MercedesMenus.Notify(message, "$dealerString.\n\nYou busted and lost your bet, ${it.bet} points, ${it.user.getDisplayName(server)}.", user)
//                            }
...
//        addField("Hit", "\uD83D\uDC46", true)
//        addField("Stand", "\uD83D\uDD90", true)
//    }) : Question(message, currentPlayer.user, message.id) {
//
//        init {
//            message.addReaction("\uD83D\uDC46")
//            message.addReaction("\uD83D\uDD90")
...
//                            if(getValue(currentPlayer.cards) == 21){
//                                MercedesMenus.Notify(reaction.message, "You got 21, and must stand, ${currentPlayer.user.getDisplayName(server)}.", user)
//                            } else {
//                                MercedesMenus.Notify(reaction.message, "You got ${getValue(currentPlayer.cards)}, and busted, ${currentPlayer.user.getDisplayName(server)}.", user)
//                            }
//                        }
